    ...
    >
      <div className="container grid h-full w-full grid-cols-4 items-start justify-between gap-4 bg-white ">
        <div className="col-span-1 my-2 h-full flex-col border-r px-2">
          <p className="py-2 text-sm font-bold"></p>
          <div className="grid grid-cols-2 gap-4">
            <a href="dien-thoai-iphone" title="iPhone">
              <p className="text-sm font-normal hover:text-ddv ">iPhone</p>
            </a>
            <a href="apple-ipad" title="Apple iPad">
              <p className="text-sm font-normal hover:text-ddv ">Apple iPad</p>
            </a>
            <a href="apple-macbook-imac" title="MacBook">
              <p className="text-sm font-normal hover:text-ddv ">MacBook</p>
            </a>
            <a href="dong-ho-apple-watch" title="Apple Watch">
              <p className="text-sm font-normal hover:text-ddv ">Apple Watch</p>
            </a>
            <a href="apple-airpods" title="Apple AirPods">
              <p className="text-sm font-normal hover:text-ddv ">Apple AirPods</p>
            </a>
            <a href="phu-kien-apple-chinh-hang" title="Phụ kiện Apple">
              <p className="text-sm font-normal hover:text-ddv ">Phụ kiện Apple</p>
            </a>
          </div>
        </div>
          ...
          >
            <div className="my-2 flex items-center justify-start">
              ...
              <div className="flex-col items-center justify-start">
                ...
                <div className="flex items-center justify-start">
                  <p className="px-3 text-14 font-medium text-ddv">2.560.000</p>
                </div>
              </div>
              <div></div>
            </div>
          ...
          >
            <div className="my-2 flex items-center justify-start">
              ...
              <div className="flex-col items-center justify-start">
                ...
                <div className="flex items-center justify-start">
                  <p className="px-3 text-14 font-medium text-ddv">15.790.000</p>
                </div>
              </div>
              <div></div>
            </div>
          ...
          >
            <div className="my-2 flex items-center justify-start">
              ...
              <div className="flex-col items-center justify-start">
                ...
                <div className="flex items-center justify-start">
                  <p className="px-3 text-14 font-medium text-ddv">18.390.000</p>
                </div>
              </div>
              <div></div>
            </div>
